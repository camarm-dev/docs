...
!!! info ""
    EcoleDirecte est une marque déposée de la société [Aplim :octicons-link-external-24:](https://aplim.fr/){target='_blank'}. Papillon n'est pas affilié à EcoleDirecte.

!!! info ""
    Skolengo est une marque déposée de la société [Kosmos :octicons-link-external-24:](https://www.skolengo.com/fr/mentions-legales){target='_blank'}. Papillon n'est pas affilié à Skolengo.
